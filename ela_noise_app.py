...
with tab1:
    ...
    # Sidebar for Noise Analysis parameters
    image_path_noise = st.file_uploader("Upload an image for Noise Analysis", type=["png", "jpg", "jpeg"], key="noise")
    ...
    if image_path_noise is not None:
        ...
        original_noise, noise_image = noise_analysis(image_noise, noise_amplitude, equalize_histogram)
...
with tab2:
    ...
    # Sidebar for Error Level Analysis parameters
    image_path_ela = st.file_uploader("Upload an image for Error Level Analysis", type=["png", "jpg", "jpeg"], key="ela")
